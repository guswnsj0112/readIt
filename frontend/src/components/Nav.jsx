...
function Nav() {
  ...
  return (
    <>
      <nav className="flex justify-between items-center max-w-9/10 lg:max-w-[75.00rem] md:max-w-[48.125rem] mt-2 m-auto py-0 px-2 md:px-5 lg:px-6  border-b-2 border-gray-1">
        <Link to="/">
