  ...
  return (
    <div className="Home">
      ...
      <main className="lg:max-w-[75.00rem] my-0 m-auto py-0 px-6 flex flex-col items-center text-main-fon">
        ...
        <div className="grid grid-cols-[repeat(3,_1fr)] gap-8 my-10 mx-0 py-0 px-5">
          <section className="bg-white lg:rounded-2xl p-6 text-center hover:scale-105 transition-transform duration-300">
            <div className="text-4xl mb-4 bg-white">✍️</div>
            <h4 className="font-bold text-xl mb-2 text-main-font bg-white">감성 기록.</h4>
            <p className="text-base leading-normal text-[#7e6d61] bg-white">책을 읽으며 느낀 점을 섬세하게 남길 수 있어요.</p>
          </section>
          <section className="bg-white lg:rounded-2xl p-6 text-center hover:scale-105 transition-transform duration-300">
            <div className="text-4xl mb-4 bg-white">📷</div>
            <h4 className="font-bold text-xl mb-2 text-main-font bg-white">이미지와 함께.</h4>
            <p className="text-base leading-normal text-[#7e6d61] bg-white">책 이미지와 함께 감상평을 기록해보세요.</p>
          </section>
          <section className="bg-white lg:rounded-2xl p-6 text-center hover:scale-105 transition-transform duration-300">
            <div className="text-4xl mb-4 bg-white">📚</div>
            <h4 className="font-bold text-xl mb-2 text-main-font bg-white">나만의 서재.</h4>
            <p className="text-base leading-normal text-[#7e6d61] bg-white">읽은 책을 한눈에, 나만의 컬렉션으로 <br />저장.</p>
          </section>
        </div>
      ...
      <p className="text-xl font-medium mb-6 text-main-font">
        ...
        <div className="mt-24 w-4/5">
          <div className="flex flex-col items-center text-center">
            <h2 className="text-[25px]  mb-1 lg:text-[2.50rem] leading-none font-bold m-auto">지금, 감동을 기록하세요.</h2>
            <p className="mt-0 mb-5 lg:text-[1.38rem] leading-7 font-medium text-gray-1">책의 여운, 감성 그대로 남기기.</p>
            <Link to="/createbookwhisper" className="bg-[#fcefe9] text-[#5a4231] text-base py-3 px-6 rounded-3xl hover:bg-[#f5e1d5]">
              👉 책과 나의 순간, 기록하기
            </Link>
          </div>
        </div>
      ...
      <footer>
        <p className="text-center lg:text-[0.81rem] text-[#999] mt-16 mx-0 mb-8">© 2025 ReadIt. 책과 감성의 순간을 함께합니다.</p>
      </footer>
    </div>
  );
}
